...
\Cref{prop:step_dir} states that the first order model allows to find the decreasing direction, but if the gradient is $0$ we do not know if we are in presence of a minimum, maximum or saddle point.
