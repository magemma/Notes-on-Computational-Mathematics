...
In the implementation of the \Cref{alg:29novarnoldi} if we have a breakdown at step $n+1$, this means that $w = A_q n$ has already enough $q_i$s, so $q_{n+1} \beta_{n+1} = 0$.
