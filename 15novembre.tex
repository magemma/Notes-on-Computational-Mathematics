...
\begin{example}
  ...
  It's about $10^8$, since in that problem we generated $b= A \begin{pmatrix} 3 & 4 & 5 \end{pmatrix}$, so $b$ lies in the image of $A$ ($Im(A)$). The geometric idea in \Cref{fig:15nov2}.
