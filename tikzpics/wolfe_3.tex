...
\begin{document}
    ...
    \begin{tikzpicture}[declare function={
	  ...
	  \addplot[mark=text, mark options={fill=red}, text mark={\tiny $y(\alpha) = \varphi'(0)\alpha + \varphi(0)$}] coordinates {(-1.5, 13)};
		...
		\addplot[domain=-.4:1.2,thick,dotted, blue] (x,{rt1(x)});
		\addplot[domain=.9:2.5,thick,dotted, blue] (x,{t2(x)});
		\addplot[domain=.9:2.5,thick,dotted, blue] (x,{rt2(x)});	
		\addplot[domain=1.8:3.4,thick,dotted, blue] (x,{t3(x)});
		\addplot[domain=1.8:3.4,thick,dotted, blue] (x,{rt3(x)});
	  
		\addplot[domain=0.35:.6, very thick] (x, {i(x)});
		...
		\addplot[mark=*,mark size=1,mark options={fill=black}] coordinates {(.56,0)} node{};
		\addplot[mark=*,mark size=.8,mark options={fill=black},dotted] coordinates {(0.56, 0) (0.56, 2.58)} node{};
		
		\addplot[domain=1.42:1.62, very thick] (x, {i(x)});
		\addplot[mark=*,mark size=1,mark options={fill=black}] coordinates {(1.42, 0)} node{};
		\addplot[mark=*,mark size=1,mark options={fill=black}] coordinates {(1.62,0)} node{};
		\addplot[mark=*,mark size=.8,mark options={fill=black},dotted] coordinates {(1.42, 0) (1.42, 5.41)} node{};
		\addplot[mark=*,mark size=.8,mark options={fill=black},dotted] coordinates {(1.62, 0) (1.62, 5.41)} node{};
		
		\addplot[domain=2.579:2.75, very thick] (x, {i(x)});
		...
		\addplot[mark=*,mark size=1,mark options={fill=black}] coordinates {(2.75,0)} node{};
		\addplot[mark=*,mark size=.8,mark options={fill=black},dotted] coordinates {(2.75, 0) (2.75, .38)} node{};
